...
if (!class_exists('Taxonomy_Term_Image')) :
    ...
    class Taxonomy_Term_Image
    {
        ...
        private $taxonomies = array('da-doctors');
        ...
        private function __construct()
        {
            ...
            $this->js_dir_url = apply_filters('taxonomy-term-image-js-dir-url', plugin_dir_url(__FILE__) . '../admin/js');
        ...
        function taxonomy_term_image_field($image_ID = null)
        {
            ...
            ?>
            <input type="button" class="taxonomy-term-image-attach button"
                   value="<?php echo esc_attr($this->labels['imageButton']); ?>"/>
            <input type="button" class="taxonomy-term-image-remove button"
                   value="<?php echo esc_attr($this->labels['removeButton']); ?>"/>
            <input type="hidden" id="taxonomy-term-image-id" name="taxonomy_term_image"
